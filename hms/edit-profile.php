...
if(isset($_POST['submit']))
{
    ...
    $sql = mysqli_query($connect,"UPDATE users SET fullName='$fname', address='$address', city='$city', gender='$gender' WHERE email='".$_SESSION['login']."'");
    if($sql)
    {
...
<html lang="en">
<head>
    <title>User | Chỉnh sửa Hồ sơ</title>
    <meta charset="utf-8" />
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">User | Chỉnh sửa Hồ sơ</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>User </span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <?php
                                            $sql = mysqli_query($connect,"SELECT * FROM users WHERE email='".$_SESSION['login']."'");
